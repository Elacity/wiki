...
- **[Contract API Reference](references/README.md)** - Complete API documentation for gateways, channels, operatives, modules, and storage contracts
- **[Contract Index](references/SUMMARY.md)** - Full listing of all documented contracts
...
- Explore [**Contract References**](references/README.md) for API documentation
