...
```solidity
constructor(address _authority, address _tradeGateway, address _registry, contract IPaymentProcessorFactory _ppf, address _implementation) internal
```
...
```solidity
constructor(address _authority, address _tradeGateway, address _registry, contract IPaymentProcessorFactory _ppf, address _implementation) public
```
